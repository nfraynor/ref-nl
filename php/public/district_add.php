...
if ($name === '') {
    header('Location: divisions.php?err=1&msg=' . urlencode('District name required'));
    exit;
}
...
try {
    ...
    header('Location: divisions.php?msg=' . urlencode('District added'));
} catch (PDOException $e) {
    $dup = ($e->getCode() === '23000');
    $msg = $dup ? 'District already exists' : ('Insert failed: ' . $e->getMessage());
